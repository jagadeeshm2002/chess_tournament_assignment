...
export default function EditTournament() {
  ...
  const [tournament, setTournament] = useState<
    typeof createTournamentSchema._type
  >({} as typeof createTournamentSchema._type);
  ...
  const {
    ...
    formState: { errors },
    setValue,
  } = useForm<typeof createTournamentSchema._type>({
  ...
  useEffect(() => {
    if (tournament) {
      Object.keys(tournament).forEach((key) => {
        setValue(key as keyof typeof createTournamentSchema._type, tournament[key as keyof typeof createTournamentSchema._type]);
      });
    }
  }, [tournament, setValue]);
